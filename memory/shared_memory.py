...
def create_shared_block(dimension: tuple):
    a = np.ones(shape=dimension, dtype=np.int64)  # Start with an existing NumPy array
...
if current_process().name == "MainProcess":
    ...
    shr, np_array = create_shared_block((5000, 23))
